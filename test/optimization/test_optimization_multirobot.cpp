...
// kink example
BOOST_AUTO_TEST_CASE(t_multi_robot_kink) {

  bool sum_robots_cost = 1;
  std::string env_file =
      DYNOBENCH_BASE "envs/multirobot/example/swap2_unicycle_kink.yaml";
  std::string initial_guess_file =
      DYNOBENCH_BASE "envs/multirobot/results/kink_db.yaml";
  ...
  multi_out.to_yaml_format("/tmp/test_multi_robot_kink_solution.yaml");
}

BOOST_AUTO_TEST_CASE(t_multi_robot_drone4c_res) {

  bool sum_robots_cost = 1;
  std::string env_file =
      DYNOBENCH_BASE "envs/multirobot/example/drone4c_res.yaml";
  std::string initial_guess_file =
  ...
  multi_out.to_yaml_format("/tmp/test_multi_robot_drone4c_res_solution.yaml");
}

// hetero case with large, small drones
BOOST_AUTO_TEST_CASE(t_hetero_robot_swap3_res) {

  bool sum_robots_cost = 1;
  std::string env_file =
      DYNOBENCH_BASE "envs/multirobot/example/swap3_drone_res.yaml";
  std::string initial_guess_file =
      DYNOBENCH_BASE "envs/multirobot/results/swap3_drone_res.yaml";
  ...
  multi_out.to_yaml_format("/tmp/test_het_swap3_drone_res_solution.yaml");
}
// wall example with 8 robots
BOOST_AUTO_TEST_CASE(t_wall_drone8_res) {

  bool sum_robots_cost = 1;
  std::string env_file =
      DYNOBENCH_BASE "envs/multirobot/example/wall_drone8_res.yaml";
  std::string initial_guess_file =
      // DYNOBENCH_BASE "envs/multirobot/results/wall_drone8_res.yaml"; //
      // collision constraint fails, initial guess was obtained with prev. k-nn
      // DYNOBENCH_BASE "envs/multirobot/results/wall_drone8_opt.yaml";
      DYNOBENCH_BASE "envs/multirobot/results/wall8.yaml";
  ...
  multi_out.to_yaml_format("/tmp/test_wall_drone8_res_solution.yaml");
}

// drone10c with residuals
BOOST_AUTO_TEST_CASE(t_drone10_res) {

  bool sum_robots_cost = 1;
  std::string env_file =
      DYNOBENCH_BASE "envs/multirobot/example/drone10c_res.yaml";
  std::string initial_guess_file =
      DYNOBENCH_BASE "envs/multirobot/results/drone10c_res.yaml";
  // DYNOBENCH_BASE "envs/multirobot/results/drone10c_res_opt.yaml";
  ...
  multi_out.to_yaml_format("/tmp/test_drone10_res_solution.yaml");
}

// drone16c with residuals
BOOST_AUTO_TEST_CASE(t_drone16_res) {

  bool sum_robots_cost = 1;
  std::string env_file =
      DYNOBENCH_BASE "envs/multirobot/example/drone16c_res.yaml";
  std::string initial_guess_file =
      DYNOBENCH_BASE "envs/multirobot/results/drone16c_res.yaml";
  // DYNOBENCH_BASE "envs/multirobot/results/drone16c_res_opt.yaml";
  ...
  multi_out.to_yaml_format("/tmp/test_drone16_res_solution.yaml");
}

// drone24c with res
BOOST_AUTO_TEST_CASE(t_drone24c_res) {

  bool sum_robots_cost = 1;
  std::string env_file =
      DYNOBENCH_BASE "envs/multirobot/example/drone24c_res.yaml";
  std::string initial_guess_file =
      DYNOBENCH_BASE "envs/multirobot/results/drone24c_res_1.yaml";
  // DYNOBENCH_BASE "envs/multirobot/results/drone24c_res_opt.yaml";
