...
BOOST_AUTO_TEST_CASE(test_eval_multiple) {
  ...
  for (size_t j = 0; j < options.size(); j++) {
    ...
    BOOST_REQUIRE_NO_THROW(tdbastar(
        problem, option, traj_out, /*constraints*/ {}, info_out, robot_id, upper_bounds[robot_id], hs[robot_id],
...
BOOST_AUTO_TEST_CASE(test_eval_reverse) {
  ...
  BOOST_REQUIRE_NO_THROW(tdbastar(problem, o_uni1, traj_out, /*constraints*/ {},
                                  info_out, robot_id, upper_bounds[robot_id], hs[robot_id], /*reverse_search*/ true,
  ...
  BOOST_REQUIRE_NO_THROW(tdbastar(problem, o_uni1, traj_out, /*constraints*/ {},
                                  info_out, robot_id, upper_bounds[robot_id], hs[robot_id], /*reverse_search*/ false,
